...
public class _09_StringToLowerCase {
    public static void main(String[] args) {
        ...
        System.out.println("text.LoverCase()="+text.toLowerCase());//merhaba dünya

        System.out.println(" me ile veya ME ile başlıyor mu="+ text.toLowerCase().toLowerCase().startsWith("me"));//true
